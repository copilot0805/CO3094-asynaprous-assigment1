...
Chức năng: Proxy sẽ lắng nghe tại cổng 8080 và điều hướng yêu cầu đến các máy chủ backend dựa trên Header Host.
...
Kiểm tra: Sử dụng Postman để gọi thử các API trên cổng 8000.
